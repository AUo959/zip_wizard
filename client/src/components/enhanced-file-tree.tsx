  ...
  const renderGroupView = () => (
    <div className="space-y-4">
      {smartGroups.map((group) => {
        ...
        const groupFiles = selectedGroup === "all" || selectedGroup === group.id 
          ? group.files.filter(f => !searchQuery || 
        ...
        <CardContent>
          <div className="space-y-3 text-xs">
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline">{files.filter(f => f.language === 'JavaScript').length}</Badge>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <Badge variant="outline" className="bg-orange-100 text-orange-800">
                {files.filter(f => f.name.toLowerCase().includes('crypto') || f.name.toLowerCase().includes('security')).length}
              </Badge>
            </div>
          </div>
        </CardContent>
