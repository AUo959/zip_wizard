...
export function HomeWithDynamicBadges() {
  ...
  const badgeConfig = {
    'vulnerability-scanner': vulnerabilities > 0 
      ? { type: 'warning' as const, value: vulnerabilities }
      : undefined,
    'status': unreadNotifications > 0
      ? { type: 'count' as const, value: unreadNotifications }
      : undefined,
    'circuit-breaker': processingErrors > 0
      ? { type: 'warning' as const, value: processingErrors }
      : undefined,
    'ai': { type: 'new' as const },
  };
